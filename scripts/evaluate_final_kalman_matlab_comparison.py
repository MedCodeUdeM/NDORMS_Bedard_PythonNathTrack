...
def load_comparison(npz_path: Path, matlab_result: Path) -> tuple[pd.DataFrame, pd.DataFrame, dict[str, object]]:
...
def main() -> None:
    ...
    metrics, per_frame, info = load_comparison(paths["npz"], args.matlab_result)
